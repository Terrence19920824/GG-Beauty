(function (root, factory) {
  ...
  const dictionaries = {
    'zh-CN': {
      ...
      pending: '待确认', confirmed: '已确认', arrived: '已到店', in_service: '服务中', completed: '已完成', cancelled: '已取消', noShow: '未到店',
    ...
    en: {
      ...
      pending: 'Pending', confirmed: 'Confirmed', arrived: 'Arrived', in_service: 'In service', completed: 'Completed', cancelled: 'Cancelled', noShow: 'No Show',
  ...
  return { DEFAULT_LOCALE, STORAGE_KEY, dictionaries, normalizeLocale, browserLocale: detectBrowserLocale, detectBrowserLocale, getStoredLocale, setLocale, t, formatDate, formatDuration, formatPrice, formatStatus, formatCheckoutStatus, resolveLocalizedService };
});
