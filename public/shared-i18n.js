(function (root, factory) {
  ...
  const dictionaries = {
    ...
    en: {
      ...
      appointmentDetails: 'Appointment Details', appointmentInfo: 'Appointment', customer: 'Customer', member: 'Member', memberCode: 'Member Code', serviceItems: 'Services', primaryStaffTitle: 'Primary Staff', assistantStaffTitle: 'Assistant Staff', paidAmount: 'Paid', finalDue: 'Total Due', outstandingAmount: 'Outstanding', booker: 'Booker', recipient: 'Recipient', bookerSameAsRecipient: 'Same as recipient', notes: 'Notes', noNotes: 'None', internalNotes: 'Internal notes', internalNotesVisibility: 'Staff only', internalNotesSave: 'Save internal notes', internalNotesSaving: 'Saving…', internalNotesSaved: 'Internal notes saved', internalNotesSaveFailed: 'Unable to save internal notes', callCustomer: 'Call', openWhatsApp: 'WhatsApp', servicesAndStaff: 'Services & Staff', statusUpdatedSuccess: 'Status updated successfully', statusUpdateFailed: 'Status update failed', close: 'Close', emailNotProvided: 'Not provided', noCustomerPhone: 'No phone number', markArrived: 'Arrived', markInService: 'In Service', markNoShow: 'No Show', markCancelled: 'Cancel',
