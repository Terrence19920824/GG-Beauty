(function (root, factory) {
  ...
  const dictionaries = {
    'zh-CN': {
      ...
      confirmAppointmentPrompt: '确定要确认这条预约吗？', arrivedAppointmentPrompt: '确认顾客已到店？', startServicePrompt: '确认开始服务？', completeAppointmentPrompt: '确定要完成这条预约吗？', cancelAppointmentPrompt: '确定要取消这条预约吗？', operationFailed: '操作失败',
    ...
    en: {
      ...
      confirmAppointmentPrompt: 'Confirm this appointment?', arrivedAppointmentPrompt: 'Mark customer as arrived?', startServicePrompt: 'Start service?', completeAppointmentPrompt: 'Complete this appointment?', cancelAppointmentPrompt: 'Cancel this appointment?', operationFailed: 'Operation failed',
