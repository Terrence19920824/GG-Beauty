(function (root, factory) {
  ...
  const dictionaries = {
    'zh-CN': {
      ...
      save: '保存', saving: '保存中...', saved: '已保存', saveFailed: '保存失败', cancel: '取消', edit: '编辑', add: '新增', confirm: '确认', complete: '完成', retry: '重试',
    ...
    en: {
      ...
      capabilities: 'Services', capabilityHeading: 'Services this staff member can perform', locations: 'Locations', weeklySchedule: 'Weekly Schedule', specialDates: 'Special Dates', saveCapabilities: 'Save Services', saveLocations: 'Save Locations', saveSchedule: 'Save Schedule', addSpecialDate: 'Add Special Date', noLocations: 'No locations', assignLocationFirst: 'Assign a location to this staff member first.', assignLocationBeforeSchedule: 'Assign a staff location before setting a schedule.', noCapabilityServices: 'No services', serviceInactive: 'Service inactive', serviceNotBookable: 'Not currently bookable',
      ...
      onlineAppointment: 'Online Appointment', chooseStaffCustomer: 'Choose Staff', appointmentDate: 'Appointment Date', availableTimes: 'Available Times', chooseDate: 'Choose a date first', customerPhone: 'Mobile Number', optionalEmail: 'Email (optional)', enterName: 'Enter your name', enterPhone: 'Enter your mobile number', bookAppointment: 'Book Appointment', loadingCustomerServices: 'Loading services...', noCustomerServices: 'No services available', checking: 'Checking...', noTimes: 'No times available', submitting: 'Submitting...', availabilityFailed: 'Unable to load available times', requiredBookingFields: 'Enter your name, phone and date, then choose a time', bookingFailed: 'Booking failed', bookingSuccess: 'Appointment booked!', from: 'From'
    }
  };
