(function (root, factory) {
  ...
  const dictionaries = {
    'zh-CN': {
      ...
      addSelectedService: '添加该项目', addAnotherService: '＋ 继续添加项目', selectedServices: '已选项目', removeService: '删除', totalDuration: '总时长', estimatedTotal: '预计总价',
    ...
    en: {
      ...
      addSelectedService: 'Add Service', addAnotherService: '+ Add another service', selectedServices: 'Selected Services', removeService: 'Remove', totalDuration: 'Total duration', estimatedTotal: 'Estimated total',
      ...
      onlineAppointment: 'Online Appointment', chooseServiceCategory: 'Choose a Service Category', chooseStaffCustomer: 'Choose Staff', customerStaffNoPreference: 'No Preference', customerStaffChoose: 'Choose Staff', customerStaffNone: 'No staff are currently available', customerStaffLoading: 'Loading staff...', customerStaffAnyAvailable: 'Any available staff', appointmentDate: 'Appointment Date', availableTimes: 'Available Times', chooseDate: 'Choose a date first', customerPhone: 'Mobile Number', optionalEmail: 'Email (optional)', enterName: 'Enter your name', enterPhone: 'Enter your mobile number', bookAppointment: 'Book Appointment', loadingCustomerServices: 'Loading services...', noCustomerServices: 'No services are currently available for booking.', checking: 'Checking...', noTimes: 'No available times on this date.', submitting: 'Submitting...', availabilityFailed: 'Unable to load available times', requiredBookingFields: 'Enter your name, phone and date, then choose a time', bookingFailed: 'Booking failed', bookingSuccess: 'Appointment booked!', from: 'From'
    }
  };
