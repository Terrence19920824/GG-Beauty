(function (root, factory) {
  ...
  const dictionaries = {
    'zh-CN': {
      ...
      addSelectedService: '添加该项目', addAnotherService: '继续添加项目', selectedServices: '已选项目', removeService: '移除', remove: '移除', totalDuration: '预计总时长', estimatedTotal: '预计总金额', nextStep: '下一步', next: '下一步', noBookableServices: '暂无可预约项目', serviceUnavailableRetry: '项目已不可用，请重新选择', loadServicesFailed: '无法加载服务，请重试', selectedState: '已选择', bookingRecipient: '预约给谁？', bookForMyself: '为自己预约', bookForSomeoneElse: '为别人预约', yourDetails: '您的联系方式', recipientDetails: '服务接收人资料', recipientName: '服务接收人姓名', enterRecipientName: '请输入服务接收人姓名', countryRegion: '国家 / 地区', recipientPhone: '服务接收人手机号', recipientEmail: '服务接收人 Email（选填）', countrySingapore: '新加坡', countryMalaysia: '马来西亚', countryIndonesia: '印度尼西亚', countryChina: '中国', countryUnitedStates: '美国',
