(function (root, factory) {
  ...
  const dictionaries = {
    'zh-CN': {
      ...
      appointmentDetails: '预约详情', booker: '预约人', recipient: '实际顾客', bookerSameAsRecipient: '预约人同实际顾客', notes: '备注', noNotes: '无', internalNotes: '内部备注', internalNotesVisibility: '仅员工可见', internalNotesSave: '保存内部备注', internalNotesSaving: '保存中…', internalNotesSaved: '内部备注已保存', internalNotesSaveFailed: '内部备注保存失败', callCustomer: '拨打电话', openWhatsApp: '打开聊天', servicesAndStaff: '预约项目与员工', statusUpdatedSuccess: '预约状态更新成功', statusUpdateFailed: '预约状态更新失败', close: '关闭', emailNotProvided: '未填写', noCustomerPhone: '暂无电话', markArrived: '已到店', markInService: '服务中', markNoShow: '未到店', markCancelled: '取消预约',
    ...
    en: {
      ...
      appointmentDetails: 'Appointment Details', booker: 'Booker', recipient: 'Recipient', bookerSameAsRecipient: 'Same as recipient', notes: 'Notes', noNotes: 'None', internalNotes: 'Internal notes', internalNotesVisibility: 'Staff only', internalNotesSave: 'Save internal notes', internalNotesSaving: 'Saving…', internalNotesSaved: 'Internal notes saved', internalNotesSaveFailed: 'Unable to save internal notes', callCustomer: 'Call', openWhatsApp: 'WhatsApp', servicesAndStaff: 'Services & Staff', statusUpdatedSuccess: 'Status updated successfully', statusUpdateFailed: 'Status update failed', close: 'Close', emailNotProvided: 'Not provided', noCustomerPhone: 'No phone number', markArrived: 'Arrived', markInService: 'In Service', markNoShow: 'No Show', markCancelled: 'Cancel',
