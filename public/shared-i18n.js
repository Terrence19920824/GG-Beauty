(function (root, factory) {
  ...
  const dictionaries = {
    'zh-CN': {
      ...
      merchantAddress: '店铺详细地址', merchantPostalCode: '邮编', merchantMapUrl: '地图链接（选填）', merchantMapUrlHelp: '（选填）若留空，系统将根据地址和邮编自动生成 Google Maps 链接', merchantShowAddress: '在顾客预约端公开显示地址', openMap: '打开地图', address: '地址',
      ...
      checkoutStateDraft: '草稿单', checkoutStateUnpaid: '草稿单', checkoutStatePartiallyPaid: '部分支付', checkoutStatePaid: '已结账', checkoutStatePartiallyRefunded: '部分退款', checkoutStateRefunded: '已退款', checkoutStateVoid: '已作废', checkoutStateInconsistent: '结账状态异常', primaryStaff: '主理', assistantStaff: '助理', goToCheckout: '去结账', awaitingCheckout: '待结账', paid: '已结账', noServiceItems: '暂无服务项目', noStaffAssigned: '暂无员工', checkoutDisabledNotice: '前台收银结算功能正在开发中，暂未在生产环境开放。', featureGatedNoticeTitle: '前台收银结算（特性门禁）', featureGatedNoticeDesc: '收银功能目前处于安全灰度/特性门禁阶段，尚未在生产环境开放。本阶段仅建立前台工作流与状态导航基础，不连接未发布的生产收银，不执行任何实际账单扣费。', iUnderstand: '好的，我知道了',
      appointmentDetails: '预约详情', appointmentInfo: '预约信息', customer: '顾客', member: '会员', memberCode: '会员编号', serviceItems: '服务项目', primaryStaffTitle: '主要员工', assistantStaffTitle: '协助员工', paidAmount: '已付', finalDue: '应付', outstandingAmount: '待支付', booker: '预约人', recipient: '实际顾客', bookerSameAsRecipient: '预约人同实际顾客', notes: '备注', noNotes: '无', internalNotes: '内部备注', internalNotesVisibility: '仅员工可见', internalNotesSave: '保存内部备注', internalNotesSaving: '保存中…', internalNotesSaved: '内部备注已保存', internalNotesSaveFailed: '内部备注保存失败', customerProfileNotes: '顾客档案备注', customerProfileNotesHelp: '长期顾客信息与服务注意事项', customerProfileNotesSave: '保存顾客档案备注', customerProfileNotesSaving: '保存中…', customerProfileNotesSaved: '顾客档案备注已保存', customerProfileNotesSaveFailed: '顾客档案备注保存失败', noCustomerProfileNotes: '暂无顾客档案备注', callCustomer: '拨打电话', openWhatsApp: '打开聊天', servicesAndStaff: '预约项目与员工', statusUpdatedSuccess: '预约状态更新成功', statusUpdateFailed: '预约状态更新失败', close: '关闭', emailNotProvided: '未填写', noCustomerPhone: '暂无电话', markArrived: '已到店', markInService: '服务中', markNoShow: '未到店', markCancelled: '取消预约',
    ...
    en: {
      ...
      merchantAddress: 'Shop Address', merchantPostalCode: 'Postal Code', merchantMapUrl: 'Map Link (Optional)', merchantMapUrlHelp: '(Optional) If left blank, a Google Maps link will be generated automatically from the address and postal code', merchantShowAddress: 'Display address to customers', openMap: 'Open Map', address: 'Address',
      ...
      checkoutStateDraft: 'Draft', checkoutStateUnpaid: 'Draft', checkoutStatePartiallyPaid: 'Partially Paid', checkoutStatePaid: 'Paid', checkoutStatePartiallyRefunded: 'Partially Refunded', checkoutStateRefunded: 'Refunded', checkoutStateVoid: 'Voided', checkoutStateInconsistent: 'Checkout Status Issue', primaryStaff: 'Primary', assistantStaff: 'Assistant', goToCheckout: 'Checkout', awaitingCheckout: 'Awaiting Checkout', paid: 'Paid', noServiceItems: 'No service items', noStaffAssigned: 'No staff', checkoutDisabledNotice: 'Checkout / POS is currently in development and feature-gated.', featureGatedNoticeTitle: 'Front Desk Checkout (Feature Gated)', featureGatedNoticeDesc: 'Checkout is currently feature-gated awaiting backend release. This preview establishes navigation and workflow foundation without connecting to production checkout.', iUnderstand: 'Understood',
      appointmentDetails: 'Appointment Details', appointmentInfo: 'Appointment', customer: 'Customer', member: 'Member', memberCode: 'Member Code', serviceItems: 'Services', primaryStaffTitle: 'Primary Staff', assistantStaffTitle: 'Assistant Staff', paidAmount: 'Paid', finalDue: 'Total Due', outstandingAmount: 'Outstanding', booker: 'Booker', recipient: 'Recipient', bookerSameAsRecipient: 'Same as recipient', notes: 'Notes', noNotes: 'None', internalNotes: 'Internal notes', internalNotesVisibility: 'Staff only', internalNotesSave: 'Save internal notes', internalNotesSaving: 'Saving…', internalNotesSaved: 'Internal notes saved', internalNotesSaveFailed: 'Unable to save internal notes', customerProfileNotes: 'Customer Profile Notes', customerProfileNotesHelp: 'Long-term customer information and service considerations', customerProfileNotesSave: 'Save Customer Profile Notes', customerProfileNotesSaving: 'Saving…', customerProfileNotesSaved: 'Customer profile notes saved', customerProfileNotesSaveFailed: 'Unable to save customer profile notes', noCustomerProfileNotes: 'No customer profile notes', callCustomer: 'Call', openWhatsApp: 'WhatsApp', servicesAndStaff: 'Services & Staff', statusUpdatedSuccess: 'Status updated successfully', statusUpdateFailed: 'Status update failed', close: 'Close', emailNotProvided: 'Not provided', noCustomerPhone: 'No phone number', markArrived: 'Arrived', markInService: 'In Service', markNoShow: 'No Show', markCancelled: 'Cancel',
      ...
      , customerDirectory: 'Customers', customerDirectoryHelp: 'Search customers and view profiles', searchCustomers: 'Search customers', searchCustomersPlaceholder: 'Name, phone or member code', previousPage: 'Previous', nextPage: 'Next', selectCustomer: 'Select a customer to view their profile', noCustomersFound: 'No customers found', lastServiceVisit: 'Last service visit', overview: 'Overview', identityStatus: 'Identity status', verifiedMember: 'Verified member', unverifiedContact: 'Unverified contact', readOnly: 'Read only', visits: 'Visits', serviceHistory: 'Service History', serviceHistoryHelp: 'Services and staff shown by visit', noCustomerVisits: 'No visits yet'
    }
  };
