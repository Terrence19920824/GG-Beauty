(function (root, factory) {
  ...
  const dictionaries = {
    'zh-CN': {
      ...
      goToCheckout: '去结账', awaitingCheckout: '待结账', paid: '已结账', frontDeskWorkflow: '前台接待与收银流程', workflowFeaturePreview: '工作流展示', workflowAppointment: '预约', workflowArrived: '到店', workflowInService: '服务中', workflowCheckout: '去结账', workflowPaid: '已结账', checkoutDisabledNotice: '前台收银结算功能正在开发中，暂未在生产环境开放。', featureGatedNoticeTitle: '前台收银结算 (Feature Gated)', featureGatedNoticeDesc: '收银功能目前处于安全灰度/特性门禁阶段，尚未在生产环境开放。本阶段仅建立前台工作流与状态导航基础，不连接未发布的生产收银，不执行任何实际账单扣费。', iUnderstand: '好的，我知道了'
    },
    en: {
