(function (root, factory) {
  ...
  const dictionaries = {
    'zh-CN': {
      ...
      list: '列表', previousDay: '上一天', nextDay: '下一天', unassigned: '未分配', unassignedStaff: '未分配员工', noAppointmentsOnDate: '该日期暂无预约', appointmentsCount: '个预约', appointmentOverlap: '重叠', overlapNotice: '冲突预约',
    ...
    en: {
      ...
      list: 'List', previousDay: 'Previous Day', nextDay: 'Next Day', unassigned: 'Unassigned', unassignedStaff: 'Unassigned Staff', noAppointmentsOnDate: 'No appointments on this date', appointmentsCount: 'appts', appointmentOverlap: 'Overlap', overlapNotice: 'Conflict',
