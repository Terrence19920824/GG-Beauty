...
CREATE TABLE staff_permissions(shop_id uuid NOT NULL,staff_account_id uuid NOT NULL,can_view_customer_history boolean,can_view_service_notes boolean,can_view_own_sales boolean,can_view_own_commission boolean,can_view_full_customer_phone boolean,can_move_own_appointments boolean,can_update_own_appointment_status boolean NOT NULL DEFAULT false);
